...
<div id="headerbg">
  ...
  <div id="headerblank">
   <div id="header" >
    ...
    &nbsp    &nbsp     &nbsp    &nbsp     &nbsp    &nbsp    &nbsp      &nbsp &nbspWelcome <b><?php  echo"admin"; ?></b>
		</font>
    </div>
...
<div id="contentbg">
  ...
  <div id="wrapper">
    <!-- START WRAPPER ############################################################## -->
    <div id="content">
      <table  summary="Summary Here" border="1" cellpadding="15" cellspacing="0">
        <thead>
          <tr><th>ID</th>
<th>First name</th>
            <th>Last Name</th>
...
<th>Mob. no.</th>
        ...
        $r=mysql_query("select * from trainner");


		while($rr=mysql_fetch_array($r))
		{
			echo"<b><tr><td width=100>".$rr['id']."</td>
                         <td width=100>".$rr['fname']."</td>
			<td width=100>".$rr['lname']."</td>
			<td width=100>".$rr['gen']."</td>
			<td width=200>".$rr['dob']."</td>
			<td width=100>".$rr['addr']."</td>
<td width=100>".$rr['mob']."</td>
					
<td width=100>".$rr['email']."</td>
			<td width=100>".$rr['qual']."</td></tr></b>"  ;
		}			

	  ?>
	  
         </tbody>
      </table><a href="trainner_login.html">Add</a>
	<form action="trainner_delete.php" method="post">
	Enter the id <input type="text" name="id" />
    <input type="submit" value="DELETE"/> <div id="copyright">
